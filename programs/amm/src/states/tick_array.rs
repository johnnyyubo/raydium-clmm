...
impl TickState {
    ...
    pub fn cross(
        ...
        if let Some(res) = fee_growth_global_0_x64.checked_sub(self.fee_growth_outside_0_x64) {
            self.fee_growth_outside_0_x64 = res;
        }
        // self.fee_growth_outside_0_x64 = fee_growth_global_0_x64
        //     .checked_sub(self.fee_growth_outside_0_x64)
        //     .unwrap();
        if let Some(res) = fee_growth_global_1_x64.checked_sub(self.fee_growth_outside_1_x64) {
